...
/**
 * Ensure legacy/imported layout objects always contain complete style/settings
 * data so designer panels and preview rendering can safely access fields.
 */
export const hydrateLayoutConfig = (layout: LayoutConfig): LayoutConfig => {
  return {
    ...layout,
    globalStyles: {
      ...defaultGlobalStyles,
    ...
    gridConfig: layout.gridConfig
      ...
      : undefined,
    newspaperConfig: layout.newspaperConfig
      ? {
          ...defaultNewspaperConfig,
          ...layout.newspaperConfig,
        }
      : undefined,
    timelineConfig: layout.timelineConfig
      ? {
          ...defaultTimelineConfig,
          ...layout.timelineConfig,
        }
      : undefined,
    magazineConfig: layout.magazineConfig
      ? {
          ...defaultMagazineConfig,
          ...layout.magazineConfig,
        }
      : undefined,
  };
};
