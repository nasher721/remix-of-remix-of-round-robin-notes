...
export const PRINT_TEMPLATES: PrintTemplate[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { key: 'systems.gi', label: "GI", enabled: true, order: 9 },
      { key: 'systems.endo', label: "ENDO", enabled: true, order: 10 },
      { key: 'systems.heme', label: "HEME/ONC", enabled: true, order: 11 },
      { key: 'systems.infectious', label: "ID", enabled: true, order: 12 },
      { key: 'systems.skinLines', label: "L/D/A", enabled: true, order: 13 },
      { key: 'systems.skin', label: "SKIN", enabled: true, order: 14 },
      { key: 'systems.dispo', label: "DISPO", enabled: true, order: 15 },
      { key: 'medications', label: 'Medications', enabled: true, order: 16 },
      { key: 'todos', label: 'Action Items', enabled: true, order: 17 },
      { key: 'notes', label: 'Notes', enabled: true, order: 18 },
    ],
    layout: {
      columns: 1,
      patientsPerPage: 1,
  ...
  },
  {
    ...
    sections: [
      ...
      { key: 'systems.skinLines', label: "L/D/A", enabled: true, order: 7 },
