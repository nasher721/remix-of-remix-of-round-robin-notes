...
export const PRINT_TEMPLATES: PrintTemplate[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { key: 'imaging', label: 'Imaging', enabled: true, order: 3 },
      { key: 'labs', label: 'Labs', enabled: true, order: 4 },
      ...SYSTEM_KEYS.map((key, index) => ({ key: `systems.${key}`, label: SYSTEM_LABELS[key], enabled: true, order: 5 + index })),
      { key: 'medications', label: 'Medications', enabled: true, order: 5 + SYSTEM_KEYS.length },
      { key: 'todos', label: 'Action Items', enabled: true, order: 6 + SYSTEM_KEYS.length },
      { key: 'notes', label: 'Notes', enabled: true, order: 7 + SYSTEM_KEYS.length },
    ],
    layout: {
      columns: 1,
      patientsPerPage: 1,
  ...
  },
  {
    ...
    sections: [
      ...
      { key: 'systems.neuro', label: SYSTEM_LABELS.neuro, enabled: true, order: 3 },
      { key: 'systems.cv', label: SYSTEM_LABELS.cv, enabled: true, order: 4 },
      { key: 'systems.resp', label: SYSTEM_LABELS.resp, enabled: true, order: 5 },
      { key: 'systems.gi', label: SYSTEM_LABELS.gi, enabled: true, order: 6 },
      { key: 'systems.skinLines', label: SYSTEM_LABELS.skinLines, enabled: true, order: 7 },
  ...
  },
  {
    ...
    sections: [
      ...
      { key: 'systems.neuro', label: SYSTEM_LABELS.neuro, enabled: true, order: 5 },
      { key: 'systems.cv', label: SYSTEM_LABELS.cv, enabled: true, order: 6 },
      { key: 'systems.resp', label: SYSTEM_LABELS.resp, enabled: true, order: 7 },
      { key: 'systems.renalGU', label: SYSTEM_LABELS.renalGU, enabled: true, order: 8 },
      { key: 'systems.gi', label: SYSTEM_LABELS.gi, enabled: true, order: 9 },
      { key: 'systems.infectious', label: SYSTEM_LABELS.infectious, enabled: true, order: 10 },
      { key: 'systems.heme', label: SYSTEM_LABELS.heme, enabled: true, order: 11 },
      { key: 'systems.endo', label: SYSTEM_LABELS.endo, enabled: true, order: 12 },
